...
exports.Get = getRoute(router_1.MethodType.Get);
exports.Post = getRoute(router_1.MethodType.Post);
exports.Put = getRoute(router_1.MethodType.Put);
exports.Delete = getRoute(router_1.MethodType.Delete);
exports.Patch = getRoute(router_1.MethodType.Patch);
exports.Options = getRoute(router_1.MethodType.Options);
exports.Head = getRoute(router_1.MethodType.Head);
exports.All = getRoute(router_1.MethodType.All);
exports.Route = {
    get: exports.Get,
    post: exports.Post,
    put: exports.Put,
